                ...
                <div className="W-column-display-thumbs">
                    <div className="W-thumbs-buttons-and-text">
                        {isLogged() ? (
                            <>
                                {isLikeReviews ? (
                                    <a className="W-thumb-up W-bottom-buttons-size" onClick={handleLikeDelete} id={`likeButton${reviewId}`}>
                                ...
                                {isDislikeReviews ? (
                                    <a className="W-thumb-down W-bottom-buttons-size" onClick={handleDislikeDelete} id={`dislikeButton${reviewId}`}>

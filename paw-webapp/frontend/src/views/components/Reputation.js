...
export default function Reputation(props) {
    ...
    function handleAddComment(comment){
          commentService.createComment(reviewId,comment)
              .then(data => {
                  if(!data.error){
                      setAdded(!added)
                  }
                    ...
                    <div className="W-thumbs-buttons-and-text">
                        {isLogged() ? (
                            <>
                                ...
                                {isDislikeReviews ? (
                                    <a className="W-thumb-down W-bottom-buttons-size" onClick={handleDislike}>
                        ...
                        <div className="W-comment-form-div">
                            ...
                            <form modelAttribute="commentForm"  method="post" id={`commentInput${reviewId}`} className="W-comment-form">
                                ...
                                <div className="W-submit-comment-button">
                                    <button type="button" id={`subButton${reviewId}`} className="btn btn-success" onClick={() => validate(reviewId)}>{t('Comment.Title')}</button>
                                </div>
                            </form>
                        </div>
                    </div>

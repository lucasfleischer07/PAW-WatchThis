...
public class Review {
    ...
    private Long id, contentId, rating;

    public Review(Long id, String type, Long contentId, String name, String description, Long rating,String userName,String contentName) {
        this.name = name;

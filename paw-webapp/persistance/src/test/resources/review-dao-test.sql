...
insert into review (reviewId,type,contentId,userId,name,description,rating) values (2,'movie',1,1,'great movie','loved it! great actors',5);
insert into review (reviewId,type,contentId,userId,name,description,rating) values (3,'serie',2,2,'bad tv show','dont recommend it!',2);

...
insert into userviewedlist(userid,contentid) values (1,501);
insert into userviewedlist(userid,contentid) values (1,10);
insert into userwatchlist(userid,contentid) values (2,492);
insert into userviewedlist(userid,contentid) values (2,492);

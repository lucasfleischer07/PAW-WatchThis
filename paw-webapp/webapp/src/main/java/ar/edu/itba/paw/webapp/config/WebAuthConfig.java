...
public class WebAuthConfig extends WebSecurityConfigurerAdapter {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setExposedHeaders(Arrays.asList("Access-Token", "X-Refresh-Token","Link", "Location", "ETag", "Cache-Control", "Total-Elements", "Content-Type", "Total-Reviews", "Total-Review-Reports", "Total-Comment-Reports", "Total-User-Review", "Total-Content"));

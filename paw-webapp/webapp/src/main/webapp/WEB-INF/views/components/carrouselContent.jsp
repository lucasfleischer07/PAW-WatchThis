...
<div class="card-group W-card-text-carousel W-films-margin-carrousel">
  <div class="col">
    <div class="card W-films-card-body-carousel W-more-style">
      <div class="W-img-watchList-button-div">
          ...
          <c:choose>
            <c:when test="${param.userName != 'null' && !param.userWatchListContentId1}">
              <form id="<c:out value="form${param.contentId}"/>" method="post" action="<c:url value="/watchList/add/${param.contentId}"/>">
                <button id="buttonAddToWatchList" class="btn btn-secondary W-watchList-button" type="submit">
        ...
        <a class="card-img-top W-card-link-style" href="<c:url value='/${param.contentType}/${param.contentId}'/>"><img class="card-img-top" src="<c:url value="/contentImage/${param.contentId}"/>" alt="Image <c:out value="${param.contentName}"/>"></a>
      </div>

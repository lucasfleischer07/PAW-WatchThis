...
<%--<div class="card">--%>
<%--  <img src="<c:url value="${param.contentImage}"/>" class="card-img-top" alt="...">--%>
<%--  <div class="card-body">--%>
<%--    <h4 class="card-title"><c:out value="${param.contentName}"/></h4>--%>
<%--    <p class="card-text"><span class="W-span-text-info-card-movie W-card-details-color"><spring:message code="Content.Released"/> </span><c:out value="${param.contentReleased}"/></p>--%>
<%--    <p class="card-text"><span class="W-span-text-info-card-movie W-card-details-color"><spring:message code="Content.Genre"/> </span><c:out value="${param.contentGenre}"/></p>--%>
<%--    <p class="card-text"><span class="W-span-text-info-card-movie W-card-details-color"><spring:message code="Content.Creator"/> </span> <c:out value="${param.contentCreator}"/></p>--%>
<%--  </div>--%>

...
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
  <a class="card-group W-card-text-carousel W-films-margin-carrousel" href="<c:url value='/${param.contentType}/${param.contentId}'/>">
    <div class="col">
      <div class="card W-films-card-body" style="display: flex; align-items: center">
        <img src="<c:url value="/contentImage/${param.contentId}"/>" class="W-card-img-top-carousel" alt="Image <c:out value="${param.contentName}"/>">
        <div class="card-body">
          ...
          <div class="d-grid gap-2">
            <button class="btn btn-secondary W-watchList-button-carousel" type="button">
              ...
              </svg><p class="W-watchList-button-title"><spring:message code="Content.AddWatchList"/></p></button>
          </div>
        </div>
      </div>
    </div>

...
<div>
    ...
    <!-- <div class="W-column-display-thumbs">
        <div class="W-thumbs-buttons-and-text">
            <a href="#" class="W-thumb-up W-bottom-buttons-size">
            ...
            <a href="#" class="W-thumb-down W-bottom-buttons-size">
    ...
    <a href="#" class="W-bottom-buttons-size">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-reply W-bottom-buttons-size" viewBox="0 0 16 16">

                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div>
                                                    ...
                                                    <form:label path="descriptionReport" class="form-label"><spring:message code="Report.Comment.Reason"/></form:label>
<%--                                                    <p class="W-review-registration-text"><spring:message code="CreateContent.CharacterLimits" arguments="1,100"/></p>--%>
                                                    <spring:message code="Report.Comment.WriteHere" var="placeholder"/>

            ...
            <div class="W-comment-username-and-report">
                ...
                <div>
                    <c:choose>
                                                ...
                                                <div>
                                                    <ul class="W-no-bullets-list">
                                                        <li>
                                                            ...
                                                            <p><spring:message code="Report.Spam.Description"/></p>
                                                        </li>
                                                        <li>
                        ...
                        <c:otherwise>
                            <div>
                                <form class="W-delete-comment" id="<c:out value="form${param.reportType}"/>" method="post" action="<c:url value="/comment/${param.commentId}/delete"/>">

                    ...
                    <c:choose>
                        <c:when test="${param.loggedUserName != 'null'}">
                            <c:if test="${comment.user.userName == param.loggedUserName || param.isAdmin == 'true'}">
                                <form class="W-delete-form" id="formDeleteComment${comment.commentId}" method="post" action="<c:url value="/comment/${comment.commentId}/delete"/>">
                                ...
                                <div class="modal fade" id="deleteCommentModal${comment.commentId}" tabindex="-1" aria-labelledby="<c:out value="modalLabelDeleteComment${comment.commentId}"/>" aria-hidden="true">
                                ...
                                <div class="modal fade" id="reportCommentModal${comment.commentId}" tabindex="-1" aria-labelledby="reportCommentModalLabel${comment.commentId}" aria-hidden="true">
                                    <div class="modal-dialog">
                                        ...
                                        <form:form id="reportCommentForm" modelAttribute="reportCommentForm" action="${postPath}" method="post" enctype="multipart/form-data">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="reportCommentModalLabel${comment.commentId}"><spring:message code="Report.CommentTitle"/></h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <div>

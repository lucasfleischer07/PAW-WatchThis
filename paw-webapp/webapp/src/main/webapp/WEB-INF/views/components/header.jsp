                            ...
                            <div class="btn-group-vertical" role="group" aria-label="Button group with nested dropdown">
                                <div class="list-group">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" id="drop2">
                                            <c:url value="/movies/filters" var="postPath">
                                ...
                                <div class="list-group">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="<c:url value="/movies/filters">
                                                                                                <c:if test="${param.query != 'ANY' && param.query!=null}">
                                                                                                    <c:param name="query" value="${param.query}"/>
                                                                                                </c:if>
                                                                                                <c:if test="${param.genre != 'ANY' && param.genre!=null}">
                            ...
                            <div class="btn-group-vertical" role="group" aria-label="Button group with nested dropdown">
                                <div class="list-group">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" id="drop2">
                                            <c:url value="/series/filters" var="postPath">
                                                <c:if test="${param.query != 'ANY' && param.query!=null}">
                                                    <c:param name="query" value="${param.query}"/>
                                                </c:if>
                                                <c:if test="${param.durationFrom != 'ANY' && param.durationFrom!=null}">
                                ...
                                <div class="list-group">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="<c:url value="/series/filters">
                                                                                                <c:if test="${param.query != 'ANY' && param.query!=null}">
                                                                                                    <c:param name="query" value="${param.query}"/>
                                                                                                </c:if>
                                                                                                <c:if test="${param.genre != 'ANY' && param.genre!=null}">
                            ...
                            <div class="btn-group-vertical" role="group" aria-label="Button group with nested dropdown">
                                <div class="list-group">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" id="drop2">
                                            <c:url value="/all/filters" var="postPath">
                                                <c:if test="${param.query != 'ANY' && param.query!=null}">
                                                    <c:param name="query" value="${param.query}"/>
                                                </c:if>
                                                <c:if test="${param.durationFrom != 'ANY' && param.durationFrom!=null}">
                                ...
                                <div class="list-group">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="<c:url value="/all/filters">
                                                                                                <c:if test="${param.query != 'ANY' && param.query!=null}">
                                                                                                    <c:param name="query" value="${param.query}"/>
                                                                                                </c:if>
                                                                                                <c:if test="${param.genre != 'ANY' && param.genre!=null}">

...
<div>
    ...
    <c:if test="${param.canComment == 'true'}">
        <div class="W-reply-button-div">
            <c:choose>
                <c:when test="${param.loggedUserName != 'null'}">
                    <button class="W-reply-button btn btn-white" id="commentButton" onclick="changeVisibility('<c:out value="commentInput${param.reviewId}"/>')" >
            ...
            <div class="W-comment-form-div">
                ...
                <form:form modelAttribute="commentForm" action="${postPath}" method="post" id="commentInput${param.reviewId}" cssClass="W-comment-form">
                    ...
                    <div class="W-submit-comment-button">
                        <button type="button" id="subButton" class="btn btn-success" onclick="validate(<c:out value="${param.reviewId}"/>)"><spring:message code="Comment.Title"/></button>
                    </div>
                </form:form>
            </div>
        </div>

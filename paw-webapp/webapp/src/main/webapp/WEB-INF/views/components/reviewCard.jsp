                            ...
                            <c:choose>
                                <c:when test="${param.loggedUserName != 'null'}">
                                    <c:if test="${(!param.alreadyReport) && (param.userName != param.loggedUserName)}">
                                        ...
                                        <button id="reportReviewButton${param.reviewId}" type="button" class="btn btn-light W-background-color-report" data-bs-toggle="modal" data-bs-target="#<c:out value="reportReviewModal${param.reviewId}"/>">
                                ...
                                <c:otherwise>
                                    <c:if test="${param.userName != param.loggedUserName}">
                                        <spring:message code="Report.Review.Add" var="reportReviewAdd"/>
                                        <span title="${reportReviewAdd}">
                                            <button id="reportReviewButton${param.reviewId}" type="button" class="btn btn-light" data-bs-toggle="modal" data-bs-target="#<c:out value="reportReviewModalNoLogin${param.reviewId}"/>">

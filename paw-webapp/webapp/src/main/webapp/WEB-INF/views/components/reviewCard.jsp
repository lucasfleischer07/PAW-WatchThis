...
<div class="accordion" id="<c:out value="accordion${param.reviewId}"/>">
    <div class="accordion-item">
        <div class="accordion-header" id="<c:out value="heading${param.reviewId}"/>">
            ...
            <p class="W-reviewScore"><c:out value="${param.reviewScore}"/></p>
            ...
            <div class="accordion-body">
                <div class="W-column-display-thumbs">
                    <div class="W-thumbs-buttons-and-text">
                        ...
                        <div>
                            <p class="W-thumbsButton-orientation"><c:out value="${param.reviewScore}"/></p>
                        </div>

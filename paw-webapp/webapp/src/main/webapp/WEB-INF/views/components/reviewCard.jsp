            ...
            <div>
                <div>
                    <c:if test="${param.userName.equals(param.loggedUserName)}">
                        <form class="W-delete-form" method="post" action="<c:url value="/review/${param.reviewId}/delete"/>">
                            <button class="" type="submit" onclick="this.form.submit()">

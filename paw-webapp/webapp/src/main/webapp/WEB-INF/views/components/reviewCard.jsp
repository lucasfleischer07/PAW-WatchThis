                        ...
                        <c:when test="${param.userName.equals(param.loggedUserName)}">
                            <div >
                                <div class="W-delete-edit-buttons">
                                    <a class="W-edit-button-review" href="<c:url value="/reviewForm/edit/${param.contentType}/${param.contentId}/${param.reviewId}"/>" onclick="(this).disabled = true; (this).className += ' spinner-border text-dark'; (this).innerText = ''; document.getElementById('deleteReviewButton').disabled=true; document.getElementById('editReviewButton').disabled=true">

    ...
    <div class="accordion-item">
        <div class="accordion-header" id="<c:out value="heading${param.reviewId}"/>">
                        ...
                        <div>
                            <c:choose>
                                <c:when test="${param.loggedUserName != 'null'}">
                                    <button id="reportReviewButton" type="button" class="btn btn-light W-background-color-report" data-bs-toggle="modal" data-bs-target="#reportReviewModal">
                                            ...
                                            <form:form id="reportReviewForm" modelAttribute="reportReviewForm" action="${postPath}" method="post" enctype="multipart/form-data">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="reportReviewModalLabel"><spring:message code="Report.ReviewTitle"/></h5>
            ...
            <%--                                                    <p class="W-review-registration-text"><spring:message code="CreateContent.CharacterLimits" arguments="1,100"/></p>--%>
                                ...
                                <c:otherwise>
                                    <button id="reportReviewButton" type="button" class="btn btn-light" data-bs-toggle="modal" data-bs-target="#reportReviewModalNoLogin">
                                        <svg data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="<spring:message code="Report.Review.Add"/>" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#b21e26" class="bi bi-exclamation-circle" viewBox="0 0 16 16">
                                            <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                                            <path d="M7.002 11a1 1 0 1 1 2 0 1 1 0 0 1-2 0zM7.1 4.995a.905.905 0 1 1 1.8 0l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 4.995z"/>
                                        </svg>
                                    </button>
                                    <div class="modal fade" id="reportReviewModalNoLogin" tabindex="-1" aria-labelledby="reportReviewModalNoLoginLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="reportReviewModalNoLoginLabel"><spring:message code="Report.ReviewTitle"/></h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">

                ...
                <div class="accordion-body">
                    <%--<div class="W-column-display-thumbs">
                        <div class="W-thumbs-buttons-and-text">
                            ...
                            <div>
                                <p class="W-thumbsButton-orientation"><c:out value="${param.reviewScore==null?0:param.reviewScore}"/></p>
                            </div>
                        ...
                        <div class="card W-reviewText">
                            <div class="card-body">
                                <p><c:out value="${param.reviewDescription}"/></p>
                            </div>
                        </div>

                    </div>

                    <%--               TODO: Hacer el boton de reply--%>
            </div>
        </div>
    </div>
</div>
...
<html lang="en">
  ...
  <body>
            ...
            <div class="W-general-div-infoPage-watchlistButton-and-review">
              ...
              <c:if test="${admin==true}">
                <div class="W-delete-edit-buttons">
                  <a href="<c:url value="/content/editInfo/${contentId} "/>" onclick="(this).disabled = true; (this).className += ' spinner-border text-dark'; (this).innerText = ''; document.getElementById('deleteReviewButton').disabled=true; document.getElementById('editReviewButton').disabled=true">
                  ...
                  <form  class="W-delete-form" id="<c:out value="formDelete"/>" method="post" action="<c:url value="/content/${contentId}/delete"/>">
                    <button class="btn btn-danger text-nowrap"  type="button" data-bs-toggle="modal" data-bs-target="#<c:out value="modal${contentId}"/>" >
    ...
    <div class="modal fade" id="<c:out value="modal${contentId}"/>" tabindex="-1" aria-labelledby="<c:out value="modalLabel${contentId}"/>" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">

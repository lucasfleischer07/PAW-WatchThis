                ...
                <c:choose>
                  <c:when test="${userName != 'null' && isInWatchList == 'null'}">
                    <form id="<c:out value="form${details.id}"/>" method="post" action="<c:url value="/watchList/add/${details.id}"/>">
                      <button id="watchListButton" class="btn btn-secondary W-watchlist-button-infopage" type="submit" onclick="this.form.submit(); (this).disabled = true; (this).className -= ' W-watchlist-button-infopage'; (this).className += ' spinner-border'; (this).innerText = ''; document.getElementById('viewedListButton').disabled=true">
                  ...
                  <c:otherwise>
                    <button id="watchListButton" class="btn btn-secondary W-watchlist-button-infopage" type="button" data-bs-toggle="modal" data-bs-target="#watchListModal">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-bookmark-plus W-watchList-icon" viewBox="0 0 16 16">
                        <path d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v13.5a.5.5 0 0 1-.777.416L8 13.101l-5.223 2.815A.5.5 0 0 1 2 15.5V2zm2-1a1 1 0 0 0-1 1v12.566l4.723-2.482a.5.5 0 0 1 .554 0L13 14.566V2a1 1 0 0 0-1-1H4z"/>
                        <path d="M8 4a.5.5 0 0 1 .5.5V6H10a.5.5 0 0 1 0 1H8.5v1.5a.5.5 0 0 1-1 0V7H6a.5.5 0 0 1 0-1h1.5V4.5A.5.5 0 0 1 8 4z"/>
                      </svg>
                ...
                <c:choose>
                  <c:when test="${userName != 'null' && isInViewedList == 'null'}">
                    <form id="<c:out value="form${details.id}"/>" method="post" action="<c:url value="/viewedList/add/${details.id}"/>">
                      <button id="viewedListButton" class="btn btn-secondary W-watchlist-button-infopage" type="submit" onclick="this.form.submit(); (this).disabled = true; (this).className -= ' W-watchlist-button-infopage'; (this).className += ' spinner-border'; (this).innerText = ''; document.getElementById('watchListButton').disabled=true">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-bookmark-plus W-watchList-icon" viewBox="0 0 16 16">
                  ...
                  <c:otherwise>
                    <button id="viewedListButton" class="btn btn-secondary W-watchlist-button-infopage" type="button" data-bs-toggle="modal" data-bs-target="#viewedListModal">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-bookmark-plus W-watchList-icon" viewBox="0 0 16 16">
                        <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z"/>
                        <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z"/>
                      </svg>

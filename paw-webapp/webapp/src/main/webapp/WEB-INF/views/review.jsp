    ...
    <div class="W-row-display">
      ...
      <div>
        <div class="card W-inv-film-card-margin">
          <div class="row g-0">
            <div class="col-md-4">
              <img src="https://m.media-amazon.com/images/M/MV5BMWU4N2FjNzYtNTVkNC00NzQ0LTg0MjAtYTJlMjFhNGUxZDFmXkEyXkFqcGdeQXVyNjc1NTYyMjg@._V1_QL75_UX190_CR0,6,190,281_.jpg" class="W-img-size" alt="foto ">
            </div>
            <div class="col-md-8">
              <div class="card-body">
                <h5 class="card-title">Orgullo y Prejuicio: la mejor pelicula (nombre de resenia)</h5>
                <p class="card-text">Esta es alta pelicula. y aca iria la resenia de la persona.</p>
                <p class="card-text">Casting: Keira Knightenly </p>
              </div>
            </div>
          </div>
        </div>
